...
"""
No-balancing reduced-feature TabNet model for infection internal and external validation
...
DEFAULT_EXTERNAL_TARGET_COL = "infection_label"
OUTPUT_SUBDIR = "no_balance_reduced_external_infection"

RAW_FEATURE_COLUMNS: List[str] = ['PFratio', 'GCS', 'Urine_output_8H', 'Temperature', 'Pulse', 'Respiration', 'SBP', 'WBC', 'CRP', 'Neutrophil_Seg', 'Ventilator_days', 'Antibiotics', 'Norepinephrine', 'Dopamine']

MODEL_FEATURE_COLUMNS: List[str] = ['min_PFratio', 'min_GCS', 'min_Urine_output_8H', 'max_Temperature', 'max_Pulse', 'max_Respiration', 'max_SBP', 'max_WBC', 'max_CRP', 'max_Neutrophil_Seg', 'max_Ventilator_days', 'max_Antibiotics', 'max_Norepinephrine', 'max_Dopamine']
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="No-balancing reduced-feature TabNet model for infection internal and external validation"
    )
    parser.add_argument(
        "--train-input",
        required=True,
