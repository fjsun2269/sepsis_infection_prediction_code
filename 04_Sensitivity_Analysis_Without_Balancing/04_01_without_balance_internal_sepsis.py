...
"""
No-balancing internal TabNet model for sepsis prediction
...
OUTPUT_SUBDIR = "no_balance_internal_sepsis"

RAW_FEATURE_COLUMNS: List[str] = ['PFratio', 'GCS', 'Urine_output_8H', 'Temperature', 'Pulse', 'Respiration', 'SBP', 'WBC', 'CRP', 'PCT', 'Ventilator_days', 'Antibiotics']

MODEL_FEATURE_COLUMNS: List[str] = ['min_PFratio', 'min_GCS', 'min_Urine_output_8H', 'max_Temperature', 'max_Pulse', 'max_Respiration', 'max_SBP', 'APACHEII_score', 'max_WBC', 'max_CRP', 'max_PCT', 'max_Ventilator_days', 'max_Antibiotics']
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="No-balancing internal TabNet model for sepsis prediction"
    )
    parser.add_argument(
        "--train-input",
        required=True,
